...
class UpdateProductVariantRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sku' => 'required|string|max:100|unique:product_variants,sku,'.$this->route('product_variant'),
            'barcode' => 'nullable|string|max:100|unique:product_variants,barcode,'.$this->route('product_variant'),
    ...
    public function messages(): array
    {
        return [
            ...
            'has_manual.required' => 'Thông tin có hướng dẫn sử dụng không được để trống',
            'has_manual.boolean' => 'Thông tin có hướng dẫn sử dụng phải là true hoặc false',
            'has_decals.required' => 'Thông tin có decal không được để trống',
            'has_decals.boolean' => 'Thông tin có decal phải là true hoặc false',
