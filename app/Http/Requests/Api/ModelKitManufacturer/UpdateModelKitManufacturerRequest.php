...
class UpdateModelKitManufacturerRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'name' => 'required|string|max:255|unique:model_kit_manufacturers,name,'.$this->route('model_kit_manufacturer'),
            'slug' => 'required|string|max:255|unique:model_kit_manufacturers,slug,'.$this->route('model_kit_manufacturer'),
