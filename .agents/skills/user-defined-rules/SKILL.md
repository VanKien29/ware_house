...
description: >
  LUÔN LUÔN đọc skill này trước khi viết bất kỳ code frontend nào. Đây là các quyết định
  đã được chủ dự án xác nhận và có ưu tiên cao nhất — cao hơn cả vue-best-practices
  hay tailwindcss-development. Nếu có xung đột, quy tắc ở đây thắng.
license: MIT
metadata:
  author: graduation-team
---

# Quy tắc tùy chỉnh từ người dùng (Frontend)
...
## Quy tắc hiện tại:
- `rules/frontend-javascript-only.md` — Frontend Vue dùng JavaScript thuần, không tự ý tạo TypeScript.
...
3. **Người dùng đưa ra quyết định thiết kế/UX** ảnh hưởng đến nhiều component (ví dụ: "Mọi button luôn dùng màu gradient", "Layout luôn có sidebar bên trái").

### Cách tạo file rule mới:
1. **Đặt tên file**: Dùng kebab-case mô tả ngắn gọn nội dung. Ví dụ: `button-style.md`, `layout-convention.md`, `api-call-pattern.md`.
